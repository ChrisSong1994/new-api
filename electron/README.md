# 7X API Electron Desktop App

This directory contains the Electron wrapper for 7X API, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
- **Production**:
  - macOS: `~/Library/Application Support/7X API/data/`
  - Windows: `%APPDATA%/7X API/data/`
  - Linux: `~/.config/7X API/data/`
